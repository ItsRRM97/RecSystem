...
<link rel="stylesheet" type="text/css" href="StarRating.css">
 ...
 $('div#content').empty()
 $.each(data, function() {
	 $('div#content').append('<div class="row"><div class="col-md-8"><a href="'+this.page+'" target="blank"><h2>'+ this.title + '</h2></a> <h3>'+this.desc+'</h3></div><br><div class="col-md-4"><ul><li><a href="editprofile.php?id=' + this.id + '">Edit</a></li><li><a href="remove.php?id='+this.id+'">Remove</a></li></ul></div>');
	 });
 }, "json");
 }
 });
